...
public class Person {
	...
	public static List<Person> personList() {
		return Arrays.asList(new Person("kaique", 30, 1500.00), new Person("paulo", 15, 1670.00),
				new Person("lucas", 18, 1500.00), new Person("pedro", 50, 1600.00), new Person("maria", 20, 2500.00),
				new Person("betania", 35, 2234.00), new Person("carlos", 12, 1507.00),
				new Person("larissa", 25, 1800.00), new Person("talita", 15, 1900.00),
				new Person("maicon", 17, 3500.00));
	}

	public static List<Person> personList2() {
		return Arrays.asList(new Person("kaique", 30, 1500.00, Genetos.MASCULINO),
				new Person("paulo", 15, 1670.00, Genetos.MASCULINO),
				new Person("lucas", 18, 1500.00, Genetos.MASCULINO),
				new Person("pedro", 50, 1600.00, Genetos.MASCULINO), new Person("maria", 20, 2500.00, Genetos.FEMININO),
